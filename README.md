...
Gumaca Government Web Template (gumacagwt) is a Philippine Uniform Website
Content Policy (UWCP) compliant WordPress theme based on [GWT for WordPress](https://github.com/iGovPhil/gwt-wordpress).
