...
class ArrayKeywordTest extends AbstractMethodUnitTest {
	...
	public function dataArrayKeyword() {
		return array(
			'empty array'                           => array( '/* testEmptyArray */' ),
			'array with space before parenthesis'   => array( '/* testArrayWithSpace */' ),
			'array with comment before parenthesis' => array(
				'/* testArrayWithComment */',
				'Array',
			),
			'nested: outer array'                   => array( '/* testNestingArray */' ),
			'nested: inner array'                   => array( '/* testNestedArray */' ),
		);
	...
	public function dataArrayType() {
		return array(
			...
			'function param type'        => array( '/* testFunctionDeclarationParamType */' ),
			'function union return type' => array( '/* testFunctionDeclarationReturnType */' ),
		);
	...
	public function dataNotArrayKeyword() {
		return array(
			...
			'class-method-name'   => array( '/* testClassMethod */' ),
		);
